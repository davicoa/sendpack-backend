...
const MileageMap = compose(
  withProps({
    googleMapURL:
      "https://maps.googleapis.com/maps/api/js?key=AIzaSyBvGSHhHEUPWu8S7cBHT7PxAnBo5aqeoKA&v=3.exp",
    loadingElement: <div style={{ height: `100%` }} />,
    containerElement: <div key="klj" style={{ height: `768px`,width:'100%',marginBottom:"50px;" }} />,
  ...
  <GoogleMap
    ...
    defaultZoom={13}
    center={{ lat: -27.4691869, lng: -58.8319799 }}
  >
    {props.wayPoints && props.wayPoints.map((wayPoint, wayIndex) => {
